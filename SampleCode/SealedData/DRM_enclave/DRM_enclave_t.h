#ifndef DRM_ENCLAVE_T_H__
#define DRM_ENCLAVE_T_H__
...
uint32_t create_time_based_policy(uint8_t* sealed_log, uint32_t sealed_log_size);
uint32_t perform_time_based_policy(const uint8_t* sealed_log, uint32_t sealed_log_size);
