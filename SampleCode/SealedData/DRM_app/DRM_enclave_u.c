...
static const struct {
	...
	9,
	{
		(void*)DRM_enclave_create_session_ocall,
		(void*)DRM_enclave_exchange_report_ocall,
		(void*)DRM_enclave_close_session_ocall,
		(void*)DRM_enclave_invoke_service_ocall,
		(void*)DRM_enclave_sgx_oc_cpuidex,
		(void*)DRM_enclave_sgx_thread_wait_untrusted_event_ocall,
		(void*)DRM_enclave_sgx_thread_set_untrusted_event_ocall,
		(void*)DRM_enclave_sgx_thread_setwait_untrusted_events_ocall,
		(void*)DRM_enclave_sgx_thread_set_multiple_untrusted_events_ocall,
	}
};
